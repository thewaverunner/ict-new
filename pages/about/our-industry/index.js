    ...
    return (
        <>
            ...
            <BaseSection
                ...
                description={'Direct sales are when individual salespeople reach out to consumers directly. In contrast, direct marketing is when a company markets directly to the consumer.'}
                textAlign={'center'}
                titleColor={'black'}
            />
